...
function generateExamplesReadme(entries: typeof manifest): string {
    const rows = entries.map((entry) => {
        ...
        return `| [${title}](${sourceFile}) | <img src="https://bvolpato.github.io/vizmatic/assets/examples/${dark}" alt="${title} dark render" width="360" /> | <img src="https://bvolpato.github.io/vizmatic/assets/examples/${light}" alt="${title} light render" width="360" /> |`
    })
