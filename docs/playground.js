"use strict";(()=>{function P(t=window.location.hash){let e=t.match(/^#(?:vizmatic-playground|playground)=([\s\S]*)$/);if(e?.[1])try{return decodeURIComponent(e[1])}catch{return}}function R(t){let e=new URL(window.location.href);e.hash=`vizmatic-playground=${encodeURIComponent(t)}`,window.history.replaceState(null,"",e)}var I=new Set(["as","async","await","const","else","export","extends","from","function","if","import","interface","let","new","return","satisfies","type","var"]),q=new Set(["false","null","true","undefined"]);function S(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function g(t,e){return`<span class="syntax-${t}">${S(e)}</span>`}function x(t){return!!(t&&/[A-Za-z_$]/.test(t))}function U(t){return!!(t&&/[\w$]/.test(t))}function B(t,e){for(;/\s/.test(t[e]??"");)e+=1;return t[e]}function z(t){let e="",n=0,a=!1,u=!1,s=0;for(;n<t.length;){let l=t[n],c=t[n+1];if(l==="/"&&c==="/"){let d=t.indexOf(`
`,n),r=d===-1?t.length:d;e+=g("comment",t.slice(n,r)),n=r;continue}if(l==="/"&&c==="*"){let d=t.indexOf("*/",n+2),r=d===-1?t.length:d+2;e+=g("comment",t.slice(n,r)),n=r;continue}if(l==='"'||l==="'"||l==="`"){let d=l,r=n+1;for(;r<t.length;){if(t[r]==="\\"){r+=2;continue}if(t[r]===d){r+=1;break}r+=1}e+=g("string",t.slice(n,r)),n=r;continue}if(l==="<"&&(c==="/"||x(c))){a=!0,u=!0,e+=g("operator",l),n+=1;continue}if(a&&l==="{"){s+=1,e+=g("operator",l),n+=1;continue}if(a&&l==="}"&&s>0){s-=1,e+=g("operator",l),n+=1;continue}if(a&&s===0&&l===">"){a=!1,e+=g("operator",l),n+=1;continue}if(x(l)){let d=n+1;for(;U(t[d]);)d+=1;let r=t.slice(n,d),L=B(t,d);u?(e+=g("tag",r),u=!1):a&&L==="="?e+=g("attribute",r):I.has(r)?e+=g("keyword",r):q.has(r)?e+=g("literal",r):/^[A-Z]/.test(r)?e+=g("component",r):e+=S(r),n=d;continue}if(/\d/.test(l)){let d=n+1;for(;/[\d._]/.test(t[d]??"");)d+=1;e+=g("number",t.slice(n,d)),n=d;continue}"{}[]=(),:;/>".includes(l)?e+=g("operator",l):e+=S(l),n+=1}return e}var v=[{id:"architecture",label:"Architecture",source:`width = 1200
height = 540
...
`,D(t))}function N(t){if(t.dataset.vizmaticPlaygroundTheme==="light"||t.dataset.vizmaticPlaygroundTheme==="dark")return t.dataset.vizmaticPlaygroundTheme;let e=h(t,"[data-playground-theme], [data-vizmatic-theme]").find(n=>n.getAttribute("aria-pressed")==="true");return e?.dataset.playgroundTheme==="light"||e?.dataset.vizmaticTheme==="light"?"light":"dark"}function W(t){let e=t.dataset.vizmaticPlaygroundBackground;return e&&e!=="transparent"?e:void 0}function p(t,e,n){t.status?.setAttribute("data-state",e),t.status&&(t.status.textContent=n),t.viewport&&(t.viewport.dataset.state=e)}function M(t,e){t.error&&(t.error.hidden=!e,t.error.textContent=e??"")}function f(t,e){t&&((t instanceof HTMLButtonElement||t instanceof HTMLInputElement)&&(t.disabled=!e),t.setAttribute("aria-disabled",String(!e)))}function k(t,e,n){let a=URL.createObjectURL(new Blob([e],{type:n})),u=document.createElement("a");u.href=a,u.download=t,u.click(),window.setTimeout(()=>URL.revokeObjectURL(a),0)}function V(t,e,n,a){let u=URL.createObjectURL(new Blob([e],{type:"image/svg+xml"})),s=document.createElement("img");s.src=u,s.alt=`Vizmatic preview, ${n} by ${a}`,s.width=n,s.height=a,s.addEventListener("load",()=>URL.revokeObjectURL(u),{once:!0}),t.replaceChildren(s)}function E(t,e){t.dataset.vizmaticPlaygroundTheme=e;for(let n of h(t,"[data-vizmatic-playground-theme]"))(n instanceof HTMLSelectElement||n instanceof HTMLInputElement)&&(n.value=e);for(let n of h(t,"[data-vizmatic-theme], [data-playground-theme]")){let a=n.dataset.vizmaticTheme??n.dataset.playgroundTheme;n.setAttribute("aria-pressed",String(a===e))}}function G(t){let e=t.value;t.replaceChildren(...v.map(n=>{let a=document.createElement("option");return a.value=n.id,a.textContent=n.label,a})),t.value=y(e)?.id??v[0]?.id??""}function b(t){if(t.dataset.vizmaticPlaygroundMounted==="true")return;let e=j(t);if(!e)return;t.dataset.vizmaticPlaygroundMounted="true";let n=new H,a=P();e.templateSelect&&G(e.templateSelect),a&&(e.source.value=a),e.source.value.trim()||(e.source.value=y(e.templateSelect?.value)?.source??v[0]?.source??""),w(e);let u,s,l,c=N(t),d=i=>{e.source.value=i,w(e),s=void 0,l=void 0,e.preview.replaceChildren(),f(e.pngDownload,!1),f(e.svgDownload,!1),M(e,void 0),p(e,"loading","Rendering shared source\u2026"),r(!0)},r=(i=!1)=>{u&&window.clearTimeout(u),u=window.setTimeout(()=>{u=void 0,L()},i?0:O)},L=async()=>{let i=e.source.value;f(e.pngDownload,!1),f(e.svgDownload,!1),p(e,"loading","Rendering locally\u2026"),M(e,void 0);try{let o=await n.render({source:i,theme:c,background:W(t)});s=o.png,l=o.svg,V(e.preview,o.svg,o.width,o.height),e.dimensions&&(e.dimensions.textContent=`${o.width} \xD7 ${o.height}`),e.width&&(e.width.textContent=String(o.width)),e.height&&(e.height.textContent=String(o.height)),f(e.pngDownload,!0),f(e.svgDownload,!0),p(e,"ready",o.warnings[0]??`Ready \xB7 ${o.width}\xD7${o.height}`)}catch(o){if(o instanceof T)return;s=void 0,l=void 0;let A=o instanceof Error?o.message:String(o);p(e,"error","Error"),M(e,A)}};e.source.addEventListener("input",()=>{w(e),r()}),e.source.addEventListener("scroll",()=>D(e)),e.run?.addEventListener("click",i=>{i.preventDefault(),r(!0)}),e.pngDownload?.addEventListener("click",i=>{i.preventDefault(),s&&k("vizmatic.png",s,"image/png")}),e.svgDownload?.addEventListener("click",i=>{i.preventDefault(),l&&k("vizmatic.svg",l,"image/svg+xml")}),e.share?.addEventListener("click",i=>{i.preventDefault(),R(e.source.value);let o=window.location.href;if(!navigator.clipboard){p(e,"ready","Share link ready in address bar.");return}navigator.clipboard.writeText(o).then(()=>p(e,"ready","Share link copied.")).catch(()=>p(e,"ready","Share link ready in address bar."))});for(let i of h(t,"[data-vizmatic-playground-template]"))i.addEventListener("click",()=>{let o=y(i.dataset.vizmaticPlaygroundTemplate);o&&(e.source.value=o.source,w(e),r(!0))});for(let i of h(t,"#playgroundTemplate, select[data-vizmatic-playground-template]"))i.addEventListener("change",()=>{let o=y(i.value);o&&(e.source.value=o.source,w(e),r(!0))});for(let i of h(t,"[data-vizmatic-theme], [data-playground-theme]"))i.addEventListener("click",()=>{c=i.dataset.vizmaticTheme==="light"||i.dataset.playgroundTheme==="light"?"light":"dark",E(t,c),r(!0)});for(let i of h(t,"select[data-vizmatic-playground-theme]"))i.addEventListener("change",()=>{c=i.value==="light"?"light":"dark",E(t,c),r(!0)});t.addEventListener("vizmatic-playground-theme",i=>{if(!(i instanceof CustomEvent))return;let o=i.detail?.theme;o!=="dark"&&o!=="light"||(c=o,E(t,c),r(!0))}),window.addEventListener("hashchange",()=>{let i=P();!i||i===e.source.value||d(i)}),window.addEventListener("pagehide",()=>n.dispose(),{once:!0}),E(t,c),a?d(a):r(!0)}function F(){let t=[...document.querySelectorAll("[data-vizmatic-playground]"),document.querySelector("#vizmatic-playground"),document.querySelector("#playground")].filter(e=>!!e);for(let e of new Set(t))b(e)}function C(){let t=[...document.querySelectorAll("[data-vizmatic-playground]"),document.querySelector("#vizmatic-playground"),document.querySelector("#playground")].filter(n=>!!n);if(!("IntersectionObserver"in window)){for(let n of new Set(t))b(n);return}let e=new IntersectionObserver(n=>{for(let a of n)a.isIntersecting&&(e.unobserve(a.target),b(a.target))},{rootMargin:"600px 0px"});for(let n of new Set(t))e.observe(n)}var J=globalThis;J.VizmaticPlayground={mountAll:F,mount:b};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",C,{once:!0}):C();})();
