...
<Scene title="TSX scene at slide size" subtitle="1280x720 output with the same primitives" gap={22}>
    <Row gap={20} align="stretch">
        <Panel title="Slide frame" tone="purple" width={430} minHeight={330} justify="center">
        ...
        <Panel title="Renderer options" tone="green" width={610} minHeight={330} justify="center">
