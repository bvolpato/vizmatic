...
import { defineIllustration, ScatterPlot, Scene } from 'vizmatic'

export const width = 1040
export const height = 560

const frame = defineIllustration((c) =>
    <Scene c={c} title="Research landscape" subtitle="scatterplots stay legible without hand-placed labels" align="center">
        <ScatterPlot
            c={c}
            width={840}
            height={390}
