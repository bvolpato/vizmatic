...
import { defineIllustration, QuadrantChart, Scene } from 'vizmatic'

export const width = 1040
export const height = 560

const frame = defineIllustration((c) =>
    <Scene c={c} title="Embedding space triage" subtitle="structured scatterplots with labeled regions" align="center">
        <QuadrantChart
            c={c}
            width={860}
            height={360}
